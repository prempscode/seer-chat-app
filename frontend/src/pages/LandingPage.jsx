    ...
    <div className="landing">
      ...
      <div className={authUser ? "landing-authed" : ""}>
        ...
        <section className="features">
          ...
          <div className="features-grid">
            <div className="feature-card">
              ...
              <p>
                Real-time delivery. No delays, no drafts sitting forever. The
                Seer delivers instantly.
              </p>
            </div>
            <div className="feature-card">
              <div className="feature-icon">👁️</div>
            ...
            <div className="feature-card">
              ...
              <h3>No Walls</h3>
              <p>
                Open by design. No locks, no "seen" anxiety. Just raw,
            ...
            <div className="feature-card">
              ...
              <h3>Direct Sight</h3>
              <p>
                One-to-one chats where every message reaches its target. No
                group chaos, just clarity.
              </p>
            </div>
            <div className="feature-card">
              <div className="feature-icon">🟢</div>
        ...
        <footer className="landing-footer">
          ...
          <div className="footer-copy">✌️ Done & Dusted by prem 🎴</div>
        </footer>
      </div>
    </div>
  );
