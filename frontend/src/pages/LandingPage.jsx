...
export default function LandingPage() {
  ...
  return (
    <div className="landing">
      {/* Nav — only show when NOT authed (chat navbar already shows otherwise) */}
      {!authUser && (
      ...
      {/* When authed, add top padding so hero doesn't slam into chat navbar */}
      <div className={authUser ? "landing-authed" : ""}>
        ...
        <section className="hero">
          ...
          <p className="hero-sub">
            Real-time messaging where every word is witnessed,
            every message is seen. Speak freely — the Seer is
            always watching.
          </p>
        ...
        <section className="features">
          ...
          <div className="features-grid">
            <div className="feature-card">
              ...
              <p>
                Real-time delivery. No delays, no drafts sitting forever.
                The Seer delivers instantly.
              </p>
            </div>
            <div className="feature-card">
              <div className="feature-icon">👁️</div>
              ...
              <p>
                Your words, everyone's eyes. No filters, no disappearing
                tricks. Pure, witnessed conversation.
              </p>
            </div>
            <div className="feature-card">
              ...
              <h3>No Walls</h3>
              <p>
                Open by design. No locks, no "seen" anxiety.
                Just raw, unfiltered human connection.
              </p>
            </div>
            <div className="feature-card">
              <div className="feature-icon">📸</div>
              <h3>Picture This</h3>
              <p>
                Share images that get seen. Visual messages delivered in
                full clarity, in real-time.
              </p>
            </div>
            <div className="feature-card">
              <div className="feature-icon">💬</div>
              <h3>Direct Sight</h3>
              <p>
                One-to-one chats where every message reaches its target.
                No group chaos, just clarity.
              </p>
            </div>
            <div className="feature-card">
              <div className="feature-icon">🟢</div>
              <h3>Always Here</h3>
              <p>
                See who's online, who's watching. Presence indicators
                keep you connected to your circle.
              </p>
            </div>
          </div>
        </section>
